...
pub use tree::{
    ...
    should_preserve_checkout_path, validate_portable_source_paths, validate_portable_source_symlink,
    validate_source_entry, validate_source_paths, validate_source_tree,
    ExactProjectionDetachTarget, ExactProjectionFreeze, ExactProjectionVerification,
};
