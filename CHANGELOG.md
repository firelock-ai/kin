...
- Complete the v0.7.18 lockstep notes and npm versions (#1788)
...
- docs(claude): add plugin requirements (#1774)
- fix(cli): show continue alias in resolve help (#1776)
- Package release-matched desktop MCP binaries and maintainer metadata (#1777)
...
- Resolve every ref identity on the daemon's refs route (#1666)
- Re-vendor the preflight proof flow with its unmeasured-exit tolerance (#1667)
- Hold the coupled kin-vfs-core pin until the release input backs it (#1668)
