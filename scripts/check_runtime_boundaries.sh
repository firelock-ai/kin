...
for command_file in status work note overview graph dead_code refs xref verify commit diff log audit approvals security branch checkout rename with; do
