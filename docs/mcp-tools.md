...
| `cross_file_edges_unproduced` | The build produced no entity-level edge of a class whose sites the linker resolved, so the gap is in the linker rather than the code. |
