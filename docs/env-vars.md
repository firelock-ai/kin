...
This is the authoritative list of supported `KIN_*` environment variables (406 total, 305 correctness-relevant), generated from the central registry in `kin-core`.
